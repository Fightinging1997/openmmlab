...
def parse_args():
    ...
    parser.add_argument('--config', default="work_dirs/mask_rcnn_r50_fpn_1x_coco/mask_rcnn_r50_fpn_1x_coco.py", help='Config file')
    parser.add_argument('--checkpoint', default="work_dirs/mask_rcnn_r50_fpn_1x_coco/epoch_200.pth", help='Checkpoint file')
    parser.add_argument(
        '--device', default='cuda:0', help='Device used for inference')
    parser.add_argument(
        '--score-thr', type=float, default=0.3, help='Bbox score threshold')
    parser.add_argument('--out', default="results.mp4", type=str, help='Output video file')
